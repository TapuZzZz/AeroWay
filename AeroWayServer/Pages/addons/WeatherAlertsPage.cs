...
{
    public static class WeatherAlertsPage
    {
        public static string GenerateWeatherAlertsHtml(string connectionString)
        {
            ...
            // Generate the Weather Alerts HTML
            html.Append($@"
            ...
            <div class=""screen-too-small"">
                ...
                <button class=""screen-too-small-button"" onclick=""window.popupManager.closePopup('weatherAlertsPopup')"">Close</button>
            </div>");
